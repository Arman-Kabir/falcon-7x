...
const Home = () => {
    ...
    return (
        <div className='home-container'>
            <div className='hero-section grid grid-cols-2 my-20 w-10/12 mx-auto'>
                <div className='hero-details flex flex-col justify-center items-start'>
                    <h3 className='text-4xl text-lime-600 font-semibold'>Buy a Private jet</h3>
                    <h1 className='text-6xl text-red-600 font-bold'>Falcon-7x</h1>
                    <p className='text-slate-600 text-left'> Having a private jet is a symbol of being super rich. If u want to use a private jet for your family use or business meeting or any other work, this is the best plane u will ever have in the sky.</p>
                </div>
